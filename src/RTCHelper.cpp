...
namespace simExtRTC {
	...
	int spawnRobotRTC(const std::string& key, const std::string &arg) {
		...
		arg_oss << "RobotRTC?"
			...
			<< "conf.__widget__.controlledJointNames=checkbox&"
			<< "conf.__widget__.observedJointNames=checkbox&"
			<< "conf.__constraints__.controlledJointNames=(" << names << ")&"
			<< "conf.__constraints__.observedJointNames=(" << names << ")&"
	...
	int spawnTwoWheelMobileRobotRTC(const std::string& key, const std::string &arg) {
		...
		arg_oss << "TwoWheelMobileRobotRTC?"
			...
			// << "conf.__innerparam.argument=" << arg << "&"
			<< "conf.__widget__.rightWheelJointName=ordered_list&"
			<< "conf.__widget__.leftWheelJointName=radio&"
			<< "conf.__constraints__.rightWheelJointName=(" << names << ")&"
			<< "conf.__constraints__.leftWheelJointName=(" << names << ")&"
			<< "conf.__innerparam.objectHandle=" << objHandle << "&"
			<< "conf.__innerparam.objectName=" << key << "&"
			<< "conf.__innerparam.allNames=" << names << "&"
			<< "conf.__innerparam.allHandles=" << handles << "&"
