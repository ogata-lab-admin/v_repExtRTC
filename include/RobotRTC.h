  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedDoubleSeq m_currentPositiojn;
  /*!
   */
  OutPort<RTC::TimedDoubleSeq> m_currentPositiojnOut;
 ...
 private:
  ...
  std::vector<int32_t> m_activeJointHandle;
};
